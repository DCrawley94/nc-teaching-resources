...
class TestReversedIterator:
    ...
    @pytest.mark.it(
        "When invoked with iter a ReversedIterator instance \
    ...
    @pytest.mark.it(
        "First invocation of next should return the last element \
            in collection"
    )
    ...
    @pytest.mark.it(
        "Subsequent invocations of next should return elements in \
            return order"
    )
    ...
    @pytest.mark.it(
        "StopIteration exception is raised after elements of \
